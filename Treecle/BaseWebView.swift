...
class BaseWebView: WKWebView {
    // iOS UserAgent
    private let CUSTOM_USER_AGENT = "ios_treecle"
    ...
    init(frame: CGRect, configuration: WKWebViewConfiguration, target: MainViewController) {
...
//        }
    ...
    convenience init(target: MainViewController) {
